import FAQSection from "@/src/website/FAQSection";
import FeaturesSection from "@/src/website/FeaturesSection";
import Footer from "@/src/website/Footer";
import HeroSection from "@/src/website/HeroSection";
import HowItWorksSection from "@/src/website/HowItWorksSection";
import Navbar from "@/src/website/Navbar";
import PricingSection from "@/src/website/PricingSection";
import TestimonialsSection from "@/src/website/TestimonialsSection";
import WhoWeAreSection from "@/src/website/WhoWeAreSection";
import WhyItMattersSection from "@/src/website/WhyItMattersSection";
import AnimateIn from "@/src/website/AnimateIn";
        ...
        <section className="px-4 py-8">
          <div className="relative mx-auto max-w-9xl overflow-hidden rounded-2xl bg-[#56D197]/10 px-8 py-16 text-center">
            ...
            <AnimateIn className="relative z-10 flex flex-col items-center gap-5">
              <h2 className="max-w-xl text-3xl font-bold leading-snug text-[#111115] sm:text-4xl">
                Take the first step toward a better school system
              </h2>
              <p className="max-w-md text-base leading-relaxed text-[#4e4e55]">
                Join schools already using Axis to save time, reduce errors, and
                stay organized.
              </p>
              <Link
                href="/app.axisbydigenty.com/auth/staff?step=signup"
