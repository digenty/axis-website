  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-[#f5f0d0] px-8 py-12 text-center">
      ...
      >
        <defs>
          ...
          >
            ...
            <polygon
              points="72,8 95,5 110,20 103,44 80,48 62,33"
              fill="#c2a84e"
            />
            <polygon
              points="4,62 28,57 42,72 36,95 12,98 -4,82"
              fill="#c2a84e"
            />
            <polygon
              points="62,60 86,54 100,70 93,93 68,97 50,80"
              fill="#c2a84e"
            />
            <polygon
              points="100,68 122,62 134,78 127,100 104,104 88,90"
              fill="#c2a84e"
            />
            <polygon
              points="28,98 52,93 66,108 60,126 36,128 18,116"
              fill="#c2a84e"
            />
            <polygon
              points="86,96 108,90 122,105 115,124 92,127 74,114"
              fill="#c2a84e"
            />
          </pattern>
        </defs>
      ...
      <div className="relative z-10 flex flex-col items-center gap-4">
        <h3 className="text-lg font-bold text-[#111115]">
          Explore Axis for Yourself
        </h3>
        <p className="max-w-md text-sm leading-relaxed text-[#4e4e55]">
          Instantly access a live demo—see how easy it is to manage exams,
          results, and more.
        </p>
        <Link
        ...
        <AnimateIn>
          <div className="flex flex-col gap-3">
            ...
            <h2 className="max-w-2xl text-3xl leading-tight font-bold text-[#111115] sm:text-4xl">
              Whether you&apos;re a small school or large chain, Axis adapts to
              your needs
            </h2>
          </div>
        </AnimateIn>
          ...
          {schoolTypes.map((type, i) => (
            <AnimateIn key={type.label} delay={i * 120}>
              <div className="flex h-full flex-col gap-5 rounded-2xl border border-zinc-200/70 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
                <div
                  className={`flex h-12 w-12 items-center justify-center rounded-xl ${type.iconBg}`}
                >
                  <type.icon size={20} strokeWidth={2} className="text-white" />
                </div>
                <div className="flex flex-col gap-2">
                  <h3 className="text-base font-bold text-[#111115]">
                    {type.label}
                  </h3>
